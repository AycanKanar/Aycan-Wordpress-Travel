...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'azra_exo02_8727328e691f24719371_20220311110644_archive.zip';
	const ARCHIVE_SIZE		 = '74565997';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8727328-11110644';
    const SECONDARY_PACKAGE_HASH = 'ff1db64-11110644';
	const VERSION			 = '1.4.4';
